export const AdvertisingTechFZLLC = `
<p>The purpose of this policy is to advise you of our privacy practices including how we collect, store and use information collected from you on ~website_name~. By accessing and using our Website, you must accept the collection, use and transfer of your information in the manner described in this Privacy Policy. If you disagree with the way we collect and process information, please do not use this website.</p>

<h3>Information We Collect.</h3>

<p>We collect general types of information about you when you visit and use our Website; examples include personal information, demographic information, behavioral information, and indirect information.</p>

<p>Sometimes we collect combinations of these types of information. We also collect information about you that we acquire from a third party which may include personal, demographic, behavioral and indirect information. This collection may include, but is not limited to, first party cookies, third party cookies, anonymous cookies, persistent identifiers, email opt in, and search engine keywords. We have no access or control over these cookies and other tracking devices used by third parties. We have no responsibility or liability for the policies and practices of these parties. We automatically collect information about you using technology when you visit our Website. This includes internet protocol (IP) addresses, browser type, internet service provider (ISP), referring/exit pages, operating system, date/time stamp, and/or clickstream data. This information is collected from the use of cookies, web beacons or java script.</p>
    
<p>We will never knowingly collect any Personal Information from children under the age of 13. If we obtain actual knowledge that we have collected Personal Information about a child under the age of 13, that information will be immediately deleted from its database. Because We do not collect such information, we have no such information to use or to disclose to third parties.</p>

<h3>Collection of Information Through Cookies, Web Beacons, and JavaScript.</h3>

<p>Generally, we as well as third party vendors and supporting advertisers use technologies such as cookies, web beacons, and java scripts. These technologies collect internet protocol (IP) addresses, browser type, internet service provider (ISP), referring/exit pages, operating system, date/time stamp, and/or clickstream data. This information is used to analyze trends, administer our Website, and track user movements through our Website and demographic information about our user base as a whole. We may receive reports based on these technologies on an individual or aggregated basis.</p>
...
<p>As stated in this Policy, you have agreed to allow us to share information with third parties for their direct marketing purposes until you remove your information; and thus, you have agreed to this disclosure.</p>

<p>California customers may request further information about our compliance with this law here (support@~website_name~). Please note that we are only required to respond to one request per customer each year, and we are not required to respond to requests made by means other than through this email address.</p>

<h3>Contact Us.</h3>

<p>If you have any questions, or would like to unsubscribe from the site, you can contact us at:</p>`;
